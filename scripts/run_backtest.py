...
def run_dual_momentum():
    n = 4000
    spy = generate_closes(1, n, 100, [(0, 0.0006), (700, -0.0009), (1100, 0.0008),
                                       (1900, -0.0010), (2400, 0.0007), (3200, -0.0008)], 0.011)
    efa = generate_closes(2, n, 50, [(0, 0.0008), (700, -0.0005), (1100, 0.0004),
                                      (1900, 0.0009), (2400, -0.0006), (3200, 0.0005)], 0.012)
...
def run_rsi2():
    ...
    return run_full_gauntlet("rsi2_mean_reversion_v1", factory, events, SLEEVE_RISK, "SPY",
