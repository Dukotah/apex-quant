...
def test_buys_oversold_dip_in_uptrend():
    ...
    h = _Harness(ShortTermReversalStrategy("s", [A, B], reversal_period=3, bottom_k=1,
                                           trend_period=10, vol_window=4))
...
def test_blocks_falling_knife():
    ...
    h = _Harness(ShortTermReversalStrategy("s", [A, B], reversal_period=3, bottom_k=2,
                                           trend_period=8, vol_window=4))
    out = []
